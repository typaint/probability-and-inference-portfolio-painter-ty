...
hist(gam_gm,
     ...
     X~Gamma(shape = 3, scale = 1)")
hist(gam_am - gam_gm,
     xlab = "Arithmetic Mean - Geometric Mean",
     main = "Histogram of Difference between Arithmetic Mean 
     and Geometric Mean for X~Gamma(shape = 3, scale = 1)")
```
...
hist(norm_gm,
     ...
     main = "Histogram of Geometric Mean for
     X∼LOG NORMAL(μ = −1, σ = 1)")
hist(norm_am - norm_gm,
     xlab = "Arithmetic Mean - Geometric Mean",
     main = "Histogram of Difference between Arithmetic Mean 
     and Geometric Mean for X∼LOG NORMAL(μ = −1, σ = 1)")
```
...
hist(unif_gm,
     ...
     main = "Histogram of Geometric Mean for
     X~UNIFORM(0, 12)")
hist(unif_am - unif_gm,
     xlab = "Arithmetic Mean - Geometric Mean",
     main = "Histogram of Difference between Arithmetic Mean 
     and Geometric Mean for X~UNIFORM(0, 12)")
```
